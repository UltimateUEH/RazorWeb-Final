        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Phát sinh mã token để xác nhận email
                    var code = await _userManager.GenerateEmailConfirmationTokenAsync(user);
                    code = WebEncoders.Base64UrlEncode(Encoding.UTF8.GetBytes(code));

                    // https:localhost:5171/confirm-email?userId=userId&code=code&returnUrl=returnUrl
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, 
                        ...
                        $"Bạn đã đăng ký tài khoản trên web, vui lòng <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>bấm vào đây</a> để kích hoạt tài khoản.");
