...
namespace RazorWeb.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Người dùng có ID = '{UserId}' đã kích hoạt 2FA với một ứng dụng xác thực.", userId);

            StatusMessage = "Ứng dụng xác thực của bạn đã được xác minh. Ứng dụng xác thực của bạn đã được xác minh.";
