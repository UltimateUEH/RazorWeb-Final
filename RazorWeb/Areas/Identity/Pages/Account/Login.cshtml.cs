    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!result.Succeeded)
                {
                    // Cố gắng tìm UserName theo địa chỉ email, đăng nhập lại
                ...
                {
                    ModelState.AddModelError(string.Empty, "Đăng nhập thất bại (tài khoản không tồn tại hoặc sai email/ tên đăng nhập/ mật khẩu).");
                    return Page();
                }
            }
